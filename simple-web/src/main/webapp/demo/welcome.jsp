...
<div class="layui-row layui-col-space10 my-index-main">
    <div class="layui-col-xs4 layui-col-sm2 layui-col-md2">
        <div class="my-nav-btn layui-clear" data-href="${base}/demo/btn.html">
    ...
    <div class="layui-col-xs4 layui-col-sm2 layui-col-md2">
        <div class="my-nav-btn layui-clear" data-href="${base}/demo/form.html">
            <div class="layui-col-md5">
    ...
    <div class="layui-col-xs4 layui-col-sm2 layui-col-md2">
        <div class="my-nav-btn layui-clear" data-href="${base}/demo/table.html">
            <div class="layui-col-md5">
    ...
    <div class="layui-col-xs4 layui-col-sm2 layui-col-md2">
        <div class="my-nav-btn layui-clear" data-href="${base}/demo/tab-card.html">
            <div class="layui-col-md5">
    ...
    <div class="layui-col-xs4 layui-col-sm2 layui-col-md2">
        <div class="my-nav-btn layui-clear" data-href="${base}/demo/progress-bar.html">
            <div class="layui-col-md5">
    ...
    <div class="layui-col-xs4 layui-col-sm2 layui-col-md2">
        <div class="my-nav-btn layui-clear" data-href="${base}/demo/folding-panel.html">
            <div class="layui-col-md5">
...
<script type="text/javascript" src="${base}/echarts/echarts.min.js"></script>
